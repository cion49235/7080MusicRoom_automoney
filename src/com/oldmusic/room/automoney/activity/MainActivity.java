package com.oldmusic.room.automoney.activity;
...
import com.oldmusic.room.automoney.R;
import com.oldmusic.room.automoney.adapter.MainAdapter;
import com.oldmusic.room.automoney.data.Favorite_DBopenHelper;
import com.oldmusic.room.automoney.data.Main_Data;
import com.oldmusic.room.automoney.data.Pause_DBOpenHelper;
import com.oldmusic.room.automoney.mediaplayer.ContinueMediaPlayer;
import com.oldmusic.room.automoney.util.Crypto;
import com.oldmusic.room.automoney.util.PreferenceUtil;
import com.oldmusic.room.automoney.util.Utils;
import com.oldmusic.room.automoney.videoplayer.CustomVideoPlayer;
...
//	public static int category_which = 0;
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_TAD, "AX00056D7");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_TAD_FULL, "AX00056D8");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "wvffeba3");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/3059883361");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/4536616566");
	
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "wvffeba3");
	...
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("wvffeba3");
...
//							while (i > list.size()-1){
	...
	public void onClick(View view) {
		if(view == bt_category){
			...
			.setSingleChoiceItems(channel_title, 0, new DialogInterface.OnClickListener(){
				@Override
